...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Environment;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Error\\LoaderError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Error\\RuntimeError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Extension\\SandboxExtension;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Markup;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Sandbox\\SecurityError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Source;\n")->write("use \\org\\wplake\\acf_views\\vendors\\Twig\\Template;\n\n");
        }
        $compiler->write('/* ' . \str_replace('*/', '* /', $this->getSourceContext()->getName()) . " */\n")->write('class ' .  \substr( $compiler->getEnvironment()->getTemplateClass($this->getSourceContext()->getName(), $this->getAttribute('index')), 30 ) )->raw(" extends Template\n")->write("{\n")->indent()->write("private \$source;\n")->write("private \$macros = [];\n\n");
    }
