 ...
 */
namespace org\wplake\acf_views\vendors\Twig\Extension;

use org\wplake\acf_views\vendors\Twig\ExpressionParser;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\AddBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\AndBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\BitwiseAndBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\BitwiseOrBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\BitwiseXorBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\ConcatBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\DivBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\EndsWithBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\EqualBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\FloorDivBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\GreaterBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\GreaterEqualBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\HasEveryBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\HasSomeBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\InBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\LessBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\LessEqualBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\MatchesBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\ModBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\MulBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\NotEqualBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\NotInBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\OrBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\PowerBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\RangeBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\SpaceshipBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\StartsWithBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Binary\SubBinary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Filter\DefaultFilter;
use org\wplake\acf_views\vendors\Twig\Node\Expression\NullCoalesceExpression;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\ConstantTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\DefinedTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\DivisiblebyTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\EvenTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\NullTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\OddTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Test\SameasTest;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Unary\NegUnary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Unary\NotUnary;
use org\wplake\acf_views\vendors\Twig\Node\Expression\Unary\PosUnary;
use org\wplake\acf_views\vendors\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use org\wplake\acf_views\vendors\Twig\TokenParser\ApplyTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\BlockTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\DeprecatedTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\DoTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\EmbedTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\ExtendsTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\FlushTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\ForTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\FromTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\IfTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\ImportTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\IncludeTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\MacroTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\SetTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\UseTokenParser;
use org\wplake\acf_views\vendors\Twig\TokenParser\WithTokenParser;
use org\wplake\acf_views\vendors\Twig\TwigFilter;
use org\wplake\acf_views\vendors\Twig\TwigFunction;
use org\wplake\acf_views\vendors\Twig\TwigTest;
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\org\\wplake\\acf_views\\vendors\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\org\\wplake\\acf_views\\vendors\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\org\\wplake\\acf_views\\vendors\\twig_sprintf'),
            new TwigFilter('replace', '\\org\\wplake\\acf_views\\vendors\\twig_replace_filter'),
            new TwigFilter('number_format', '\\org\\wplake\\acf_views\\vendors\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\org\\wplake\\acf_views\\vendors\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\org\\wplake\\acf_views\\vendors\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\org\\wplake\\acf_views\\vendors\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\org\\wplake\\acf_views\\vendors\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\org\\wplake\\acf_views\\vendors\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\org\\wplake\\acf_views\\vendors\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\org\\wplake\\acf_views\\vendors\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\org\\wplake\\acf_views\\vendors\\twig_striptags'),
            new TwigFilter('trim', '\\org\\wplake\\acf_views\\vendors\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\org\\wplake\\acf_views\\vendors\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\org\\wplake\\acf_views\\vendors\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\org\\wplake\\acf_views\\vendors\\twig_join_filter'),
            new TwigFilter('split', '\\org\\wplake\\acf_views\\vendors\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\org\\wplake\\acf_views\\vendors\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\org\\wplake\\acf_views\\vendors\\twig_array_merge'),
            new TwigFilter('batch', '\\org\\wplake\\acf_views\\vendors\\twig_array_batch'),
            new TwigFilter('column', '\\org\\wplake\\acf_views\\vendors\\twig_array_column'),
            new TwigFilter('filter', '\\org\\wplake\\acf_views\\vendors\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\org\\wplake\\acf_views\\vendors\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\org\\wplake\\acf_views\\vendors\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\org\\wplake\\acf_views\\vendors\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\org\\wplake\\acf_views\\vendors\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\org\\wplake\\acf_views\\vendors\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\org\\wplake\\acf_views\\vendors\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\org\\wplake\\acf_views\\vendors\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\org\\wplake\\acf_views\\vendors\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\org\\wplake\\acf_views\\vendors\\twig_get_array_keys_filter'),
        ];
    }
...
use org\wplake\acf_views\vendors\Twig\Error\LoaderError;
use org\wplake\acf_views\vendors\Twig\Error\RuntimeError;
use org\wplake\acf_views\vendors\Twig\Extension\CoreExtension;
use org\wplake\acf_views\vendors\Twig\Extension\SandboxExtension;
use org\wplake\acf_views\vendors\Twig\Markup;
use org\wplake\acf_views\vendors\Twig\Source;
use org\wplake\acf_views\vendors\Twig\Template;
use org\wplake\acf_views\vendors\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('org\\wplake\\acf_views\\vendors\\Twig\\Extension\\SandboxExtension') && $env->getExtension('org\\wplake\\acf_views\\vendors\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
