...
use org\wplake\acf_views\vendors\Twig\FileExtensionEscapingStrategy;
use org\wplake\acf_views\vendors\Twig\NodeVisitor\EscaperNodeVisitor;
use org\wplake\acf_views\vendors\Twig\TokenParser\AutoEscapeTokenParser;
...
function twig_escape_filter(Environment $env, $string, $strategy = 'html', $charset = null, $autoescape = \false)
{
    ...
    switch ($strategy) {
        case 'html':
            ...
            $string = \twig_convert_encoding($string, 'UTF-8', $charset);
