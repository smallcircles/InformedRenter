...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Vcs_ThemeUpdateChecker', \false)) {
    class Puc_v4p13_Vcs_ThemeUpdateChecker extends \org\wplake\acf_views\vendors\Puc_v4p13_Theme_UpdateChecker implements \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_BaseChecker
    {
        /**
        ...
        public function requestUpdate()
        {
            ...
            $update = new \org\wplake\acf_views\vendors\Puc_v4p13_Theme_Update();
            ...
            $update->version = \org\wplake\acf_views\vendors\Puc_v4p13_Utils::findNotEmpty(array($remoteHeader['Version'], \org\wplake\acf_views\vendors\Puc_v4p13_Utils::get($updateSource, 'version')));
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = \org\wplake\acf_views\vendors\Puc_v4p13_Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
