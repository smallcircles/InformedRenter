...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_UpgraderStatus', \false)) {
    /**
    ...
    class Puc_v4p13_UpgraderStatus
    {
        ...
        private function getThingBeingUpgradedBy($upgrader)
        {
            ...
            $skin = $upgrader->skin;
            if (isset($skin->theme_info) && $skin->theme_info instanceof \org\wplake\acf_views\vendors\WP_Theme) {
                $themeDirectoryName = $skin->theme_info->get_stylesheet();
            } elseif ($skin instanceof \org\wplake\acf_views\vendors\Plugin_Upgrader_Skin) {
                if (isset($skin->plugin) && \is_string($skin->plugin) && $skin->plugin !== '') {
                    $pluginFile = $skin->plugin;
                }
            } elseif ($skin instanceof \org\wplake\acf_views\vendors\Theme_Upgrader_Skin) {
