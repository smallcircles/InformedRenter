...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_StateStore', \false)) {
    class Puc_v4p13_StateStore
    {
         ...
         * @return $this
         */
        public function setUpdate(\org\wplake\acf_views\vendors\Puc_v4p13_Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (\org\wplake\acf_views\vendors\Puc_v4p13_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = \intval(\org\wplake\acf_views\vendors\Puc_v4p13_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \org\wplake\acf_views\vendors\Puc_v4p13_Utils::get($state, 'checkedVersion', '');
            $this->update = null;
