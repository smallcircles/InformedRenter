...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Vcs_Api')) {
    abstract class Puc_v4p13_Vcs_Api
    {
        ...
        public function getRemoteReadme($ref = 'master')
        {
            ...
            $parser = new \org\wplake\acf_views\vendors\PucReadmeParser();
        ...
        public function getRemoteChangelog($ref, $localDirectory)
        {
            ...
            return \org\wplake\acf_views\vendors\Parsedown::instance()->text($changelog);
        }
        /**
