...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Plugin_UpdateChecker', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p13_Plugin_UpdateChecker extends \org\wplake\acf_views\vendors\Puc_v4p13_UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $this->extraUi = new \org\wplake\acf_views\vendors\Puc_v4p13_Plugin_Ui($this);
        }
        /**
        ...
        {
            $scheduler = new \org\wplake\acf_views\vendors\Puc_v4p13_Scheduler($this, $checkPeriod, array('load-plugins.php'));
        ...
        public function requestUpdate()
        {
            ...
            $update = \org\wplake\acf_views\vendors\Puc_v4p13_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_DebugBar_PluginExtension($this);
        }
        /**
        ...
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_Plugin_Package($this->pluginAbsolutePath, $this);
        }
        /**
