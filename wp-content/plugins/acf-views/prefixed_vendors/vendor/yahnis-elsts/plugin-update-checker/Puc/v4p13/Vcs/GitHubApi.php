...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Vcs_GitHubApi', \false)) {
    class Puc_v4p13_Vcs_GitHubApi extends \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Api
    {
        /**
        ...
        public function getLatestRelease()
        {
            ...
            $reference = new \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Reference(array(
            ...
            if (!empty($release->body)) {
                ...
                $reference->changelog = \org\wplake\acf_views\vendors\Parsedown::instance()->text($release->body);
            }
            return $reference;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            $reference = new \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
