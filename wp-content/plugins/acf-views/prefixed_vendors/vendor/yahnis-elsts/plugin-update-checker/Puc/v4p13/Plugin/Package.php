...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Plugin_Package', \false)) {
    class Puc_v4p13_Plugin_Package extends \org\wplake\acf_views\vendors\Puc_v4p13_InstalledPackage
    {
        /**
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \org\wplake\acf_views\vendors\Puc_v4p13_Factory::normalizePath($this->pluginAbsolutePath);
                }
