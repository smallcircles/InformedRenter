...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_UpdateChecker', \false)) {
    abstract class Puc_v4p13_UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
        {
            ...
            $this->upgraderStatus = new \org\wplake\acf_views\vendors\Puc_v4p13_UpgraderStatus();
            $this->updateState = new \org\wplake\acf_views\vendors\Puc_v4p13_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
         ...
         */
        protected function fixSupportedWordpressVersion(\org\wplake\acf_views\vendors\Puc_v4p13_Metadata $update = null)
        {
        ...
        {
            if (\class_exists('org\\wplake\\acf_views\\vendors\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
                $this->debugBarExtension = $this->createDebugBarExtension();
            }
        }
        protected function createDebugBarExtension()
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_DebugBar_Extension($this);
        }
        /**
