...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_DebugBar_Extension', \false)) {
    class Puc_v4p13_DebugBar_Extension
    {
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = \org\wplake\acf_views\vendors\Puc_v4p13_Factory::normalizePath($absolutePath);
            $pluginDir = \org\wplake\acf_views\vendors\Puc_v4p13_Factory::normalizePath(\WP_PLUGIN_DIR);
            $muPluginDir = \org\wplake\acf_views\vendors\Puc_v4p13_Factory::normalizePath(\WPMU_PLUGIN_DIR);
            $themeDir = \org\wplake\acf_views\vendors\Puc_v4p13_Factory::normalizePath(\get_theme_root());
