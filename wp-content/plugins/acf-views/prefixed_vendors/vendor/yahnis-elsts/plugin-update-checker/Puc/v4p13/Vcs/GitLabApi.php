...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Vcs_GitLabApi', \false)) {
    class Puc_v4p13_Vcs_GitLabApi extends \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Api
    {
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \org\wplake\acf_views\vendors\Puc_v4p13_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
