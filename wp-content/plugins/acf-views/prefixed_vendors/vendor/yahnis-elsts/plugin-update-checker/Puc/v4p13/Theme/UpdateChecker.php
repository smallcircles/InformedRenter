...
if (!\class_exists('org\\wplake\\acf_views\\vendors\\Puc_v4p13_Theme_UpdateChecker', \false)) {
    class Puc_v4p13_Theme_UpdateChecker extends \org\wplake\acf_views\vendors\Puc_v4p13_UpdateChecker
    {
        ...
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        /**
        ...
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_DebugBar_Extension($this, 'Puc_v4p13_DebugBar_ThemePanel');
        }
        /**
        ...
        {
            return new \org\wplake\acf_views\vendors\Puc_v4p13_Theme_Package($this->stylesheet, $this);
        }
    }
}
