...
if (!class_exists('acf_field_repeater')) :
    ...
    class acf_field_repeater extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            $this->tutorial_url = acf_add_url_utm_tags(
                'https://www.advancedcustomfields.com/resources/repeater/how-to-use-the-repeater-field/',
                'docs',
                'field-type-selection'
            );
            $this->pro = true;
        ...
        public function load_value($value, $post_id, $field)
        {
            ...
            if (!empty($field['pagination']) && $this->is_rendering) {
                ...
                if (doing_action('wp_ajax_acf/ajax/query_repeater')) {
                    $offset = (intval(
                                $_POST['paged']
                            ) - 1) * $rows_per_page; // phpcs:ignore WordPress.Security.NonceVerification.Missing -- Verified elsewhere.
        ...
        function update_value($value, $post_id, $field)
        {
            ...
            if (!empty($field['pagination']) && did_action(
                    'acf/save_post'
                ) && !isset($_POST['_acf_form'])) { // phpcs:ignore WordPress.Security.NonceVerification.Missing -- Value not used.
